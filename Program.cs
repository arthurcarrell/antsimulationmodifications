...
namespace AntSimCS
{
    class Program
    {
            ...
            do
            {
                ...
                switch (Choice)
                {
                    ...
                    case "5":
                        ...
                        break;
                    default:
                        Console.Write("Enter num 1-5 or 9");
                        break;
                }
            } while (Choice != "9");
            Console.ReadLine();
        ...
        static void displaySimulations()
        {
            Console.WriteLine("\n1:");
            Console.WriteLine("Number of nests: 2");
            Console.WriteLine("Number of food rows: 5");
            Console.WriteLine("Number of food coloumns: 5");
            Console.WriteLine("Number of food in nest: 500");
            Console.WriteLine("Number of food cells: 3");
            Console.WriteLine("Number of ants in nest: 5");
            Console.WriteLine("Pheromone strength: 1000");
            Console.WriteLine("Pheromone decay: 50");
            Console.WriteLine("\n2:");
            Console.WriteLine("Number of nests: 1");
            Console.WriteLine("Number of food rows: 5");
            Console.WriteLine("Number of food coloumns: 5");
            Console.WriteLine("Number of food in nest: 500");
            Console.WriteLine("Number of food cells: 3");
            Console.WriteLine("Number of ants in nest: 5");
            Console.WriteLine("Pheromone strength: 1000");
            Console.WriteLine("Pheromone decay: 100"); Console.WriteLine();
            Console.WriteLine("\n3:");
            Console.WriteLine("Number of nests: 1");
            Console.WriteLine("Number of food rows: 10");
            Console.WriteLine("Number of food coloumns: 10");
            Console.WriteLine("Number of food in nest: 500");
            Console.WriteLine("Number of food cells: 3");
            Console.WriteLine("Number of ants in nest: 9");
            Console.WriteLine("Pheromone strength: 1000");
            ...
            Console.WriteLine("Number of food in nest: 500");
            Console.WriteLine("Number of food cells: 3");
            Console.WriteLine("Number of ants in nest: 6");
            Console.WriteLine("Pheromone strength: 1000");
            Console.WriteLine("Pheromone decay: 25"); Console.WriteLine();
            Console.WriteLine("\n5:");
            Console.WriteLine("Number of nests: 2");
        ...
        static void customiseSimulation()
        {
            ...
            Console.WriteLine("\nHow many coloumns: ");
            int userColoumnsNum = Convert.ToInt32(Console.ReadLine());
            Console.WriteLine("\nHow much food in nests: ");
            int userFoodInNestNum = Convert.ToInt32(Console.ReadLine());
            Console.WriteLine("\nHow much food in cells: ");
            int userFoodInCellsNum = Convert.ToInt32(Console.ReadLine());
            Console.WriteLine("\nHow many ants: ");
            int userAntNum = Convert.ToInt32(Console.ReadLine());
            Console.WriteLine("\nPheromone strength: ");
            int userPheromoneStrength = Convert.ToInt32(Console.ReadLine());
            Console.WriteLine("\nPheromone Decay: ");
            int userPheromoneDecay = Convert.ToInt32(Console.ReadLine());

            Console.WriteLine("\nCustom selection:");
            Console.WriteLine($"Number of nests: {userNestNum}");
            Console.WriteLine($"Number of food rows: {userRowsNum}");
            Console.WriteLine($"Number of food coloumns: {userColoumnsNum}");
            Console.WriteLine($"Number of food in nest: {userFoodInNestNum}");
            Console.WriteLine($"Number of food cells: {userFoodInCellsNum}");
            Console.WriteLine($"Number of ants in nest: {userAntNum}");
            Console.WriteLine($"Pheromone strength: {userPheromoneStrength}");
            Console.WriteLine($"Pheromone decay: {userPheromoneDecay}");
            List<int> SimulationParameters = new List<int>();
            SimulationParameters = new List<int> { 2, 7, 7, 500, 3, 10, 500, 25 };

        }

        // thought id try something recursive
        static string GetChoice()
        {
            ...
            Console.WriteLine("Your input wasn't valid, please try again:");
            return GetChoice();
        }
